                      ...
                      <div key={i} className="attribute-card mb-3 p-3 border rounded">
                        ...
                        <div className="options-section ms-3">
                          ...
                          {attr.options?.map((opt, j) => (
                            <div key={j} className="d-flex align-items-center gap-2 mb-2">
                              <input type="text" className="form-control" placeholder="Option Label (e.g. Single Side)" value={opt.label}
                                onChange={(e) => { const o = [...attr.options]; o[j].label = e.target.value; updateAttribute(i, { options: o }); }} />
                              <input type="number" className="form-control" placeholder="Price Modifier (₹)" value={opt.priceModifier}
                                onChange={(e) => { const o = [...attr.options]; o[j].priceModifier = e.target.value; updateAttribute(i, { options: o }); }} />
                          ...
                          <button type="button" className="btn btn-sm btn-outline-primary mt-2"
                            onClick={() => updateAttribute(i, { options: [...(attr.options || []), { label: "", priceModifier: 0 }] })}>
                            + Add Option
                          </button>
                        </div>
                      </div>
